<template>
	...
	<div class="modal modal--full post--dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="button button--primary" @click="postUpload">
					<span>등록</span>
				</button>
	...
	<SelectDialog v-if="isCategorySelectClicked" :title="selectTitle" :list="selectList" @close="closeSelect"
